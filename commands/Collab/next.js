...
module.exports = class extends Command {
    constructor(...args) {
        ...
        super(...args, {
            ...
            nsfw: false,
            permissionLevel: 0,
            description: 'Picks a random collab member to go next.',
            extendedHelp: '',
            usage: '',
    ...
    async run(message, [...params]) {
        ...
        this.client.channels.cache.get('741408636793782346').send(`${message.author.username} was awarded 2 points for adding to the collab`);
