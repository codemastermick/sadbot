...
/**
 * NOTE: You need to install promise-mysql
 * https://www.npmjs.com/package/promise-mysql
 *
 * The library uses promisified mysql connections, which we need for the bot
 */
const mysql = require('promise-mysql');

/**
 * NOTE: You need to install dotenv
...
module.exports = class extends SQLProvider {
    ...
    constructor(...args) {
        ...
        this.qb = new QueryBuilder({
            ...
            boolean: { type: 'TINYINT(1)', resolver: (input) => input ? '1' : '0' },
    ...
    getColumns(table) {
        return this.runAll(`
			...
			WHERE \`TABLE_SCHEMA\` = ${sanitizeString(this.client.options.providers.default.database)}
